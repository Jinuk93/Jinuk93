...
| | | [**Research**](https://github.com/Jinuk93/02-1-RFPilot-SFT-vs-RAG-Research) | **SFT와 Advanced RAG 성능 실험 비교&분석**<br>Llama-3 모델을 활용한 **SFT vs RAG vs SFT+RAG(Hybrid)**<br>성능 비교 실험 및 분석 | `Python`<br>`Llama 3`<br>`SFT / RAG`<br>`Evaluation` |
